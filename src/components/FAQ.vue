...
const faqs = [
  ...
  { question: 'Mund ti redaktoj titrat para eksportit?', answer: 'Po. I gjithë transkripti është i redaktueshëm. Mund të ndryshosh fjalët, ritmin dhe gjatësinë e frazave.' },
    ...
    <div class="w-full h-screen relative overflow-hidden ">
      ...
      <div class="w-full h-full flex flex-col lg:flex-row relative z-10">
        ...
        <div class="w-full lg:w-2/5 h-auto lg:h-full p-6 lg:p-0 flex items-center justify-center shrink-0">
          <h1 class="text-4xl 4xl:text-8xl xl:text-7xl sm:text-5xl lg:text-6xl text-primary text-center text-kollektif-bold leading-tight">
            Pyetje të shpeshta
          </h1>
        </div>
        ...
        <div class="w-full lg:w-3/5 h-full flex flex-col justify-center items-center p-4 lg:p-12 overflow-y-auto no-scrollbar">
          <div class="w-full 4xl:max-w-6xl 2xl:max-w-4xl xl:max-w-2xl flex flex-col 4xl:gap-8 2xl:gap-4 gap-3 pb-20 lg:pb-0">
            <faqItem
