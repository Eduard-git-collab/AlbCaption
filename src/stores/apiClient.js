...
// // Proactively check session when tab becomes visible
...
//     cachedSession &&
//     sessionCacheTime &&
//     now - sessionCacheTime < CACHE_DURATION
//   ) {
...
//     // Check if error is a 401 or if it was a timeout/network error that might be auth related
