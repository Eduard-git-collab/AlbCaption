  ...
  >
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-6">
      ...
      <div class="relative h-[600px] w-full">
        ...
        <div
          ref="card1"
          class="absolute top-0 left-0 w-full rounded-2xl shadow-xl overflow-hidden border-2 border-cream bg-white"
          style="will-change: transform; z-index: 10;"
        >
          <div class="flex h-[600px]">
            <!-- Left Content -->
            <div class="w-3/5 p-12 flex flex-col justify-center relative overflow-hidden">
              ...
              <div class="relative z-10 space-y-6">
                <div>
                  <h3 class="text-5xl font-kollektif font-bold text-primary mb-6 leading-tight">
                    Bizneset Moderne Kerkojne Zgjidhje Praktike
                  </h3>
                  <p class="text-lg text-primary/80 font-poppins leading-relaxed">
            ...
            <!-- Right Illustration -->
            <div class="w-2/5 relative overflow-hidden bg-primary/5 flex items-center justify-center">
              <!-- Abstract Curves / Waves -->
              <div class="absolute inset-0 text-primary pointer-events-none">
                <svg class="w-full h-full" viewBox="0 0 100 200" preserveAspectRatio="none">
                  ...
                  <path d="M50 0 C 90 50 50 150 90 200" stroke="currentColor" stroke-width="0.5" stroke-opacity="0.15" fill="none" />
                  <path d="M70 0 C 110 50 70 150 110 200" stroke="currentColor" stroke-width="0.5" stroke-opacity="0.1" fill="none" />
                </svg>
              </div>

              <RouterLink to="/signup" class="relative z-10">
                <button class="text-kollektif text-xl hover:text-secondary hover:bg-primary text-primary py-2 px-4 rounded-lg transition-all duration-200 cursor-pointer bg-secondary">
                  Provo Falas AlbCaptions
                </button>
              </RouterLink>

              <!-- Cut-off Logo -->
              <div class="absolute -right-16 top-1/2 -translate-y-1/2 w-80 h-80 grayscale">
        ...
        >
          <div class="flex h-[600px]">
            ...
            <div class="w-2/5 relative overflow-hidden bg-primary/5 border-r border-gray-100">
              <!-- Abstract Curves / Waves (Mirrored) -->
              <div class="absolute inset-0 text-primary pointer-events-none">
                <svg class="w-full h-full" viewBox="0 0 100 200" preserveAspectRatio="none">
                   ...
                   <path d="M70 0 C 30 50 70 150 30 200" stroke="currentColor" stroke-width="0.5" stroke-opacity="0.2" fill="none" />
                   <path d="M50 0 C 10 50 50 150 10 200" stroke="currentColor" stroke-width="0.5" stroke-opacity="0.15" fill="none" />
                </svg>
              </div>

              <!-- Icon / Symbol -->
              <div class="absolute -left-16 top-1/2 -translate-y-1/2 w-80 h-80 opacity-10 flex items-center justify-center text-primary">
                 <!-- Abstract Eye/Target Icon -->
        ...
        >
          <div class="flex h-[600px]">
            ...
            <div class="w-3/5 p-12 flex flex-col justify-center relative overflow-hidden">
              ...
              <div class="relative z-10 space-y-6">
                <div>
                  ...
                  <div class="text-lg text-primary/80 font-poppins leading-relaxed space-y-4">
                    <p>
            ...
            <!-- Right Illustration -->
            <div class="w-2/5 relative overflow-hidden bg-primary/5 border-l border-gray-100">
              <!-- Abstract Curves / Waves -->
              <div class="absolute inset-0 text-primary pointer-events-none">
                <svg class="w-full h-full" viewBox="0 0 100 200" preserveAspectRatio="none">
                  <path d="M-10 0 C 30 50 -10 150 30 200" stroke="currentColor" stroke-width="0.5" stroke-opacity="0.1" fill="none" />
              ...
              <!-- Icon / Symbol -->
              <div class="absolute -right-16 top-1/2 -translate-y-1/2 w-80 h-80 opacity-10 flex items-center justify-center text-primary">
                 <!-- Sparkle/AI Icon -->
                 <svg class="w-48 h-48" fill="currentColor" viewBox="0 0 24 24">
...
onMounted(() => {
  // Use GSAP Context to make cleanup easier in Vue
  ctx = gsap.context(() => {
    const cards = [card1.value, card2.value, card3.value]
    
    // Initial setup: Card 1 visible, others hidden/displaced
    gsap.set(cards, { 
      yPercent: 100, 
      opacity: 0,
    ...
    const tl = gsap.timeline({
      scrollTrigger: {
        ...
        start: "center center", // CHANGED: Starts when section center hits viewport center
        end: "+=3000",
        scrub: 1, 
        pin: true, 
        anticipatePin: 1,
    ...
    tl.to(card2.value, {
      yPercent: 0,
      y: 40, // Pixel offset to create "stack" effect
      opacity: 1,
      duration: 1,
      ease: "power2.out"
    })
